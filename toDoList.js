...
const makeItDone = (target) => {
    ...
    const remove = target.parentNode.childNodes[2].setAttribute('onclick','removeDone(this)');
    target.className='';
    target.classList.add('fas','fa-check-square')
    target.setAttribute('onclick','uncheckDone(this)');
}

const makeItTodos = (target) => {
    target.parentNode.classList.remove('done');
    target.parentNode.classList.add('todo');
    const remove = target.parentNode.childNodes[2].setAttribute('onclick','removeTodo(this)');
    target.className='';
    target.classList.add('fas','fa-square')
    target.setAttribute('onclick','uncheckTodo(this)');
}
